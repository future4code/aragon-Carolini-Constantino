...
import { ILoginInput, ISignupInput, ISignupLoginOutput, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public signup = async (input: ISignupInput) => {
        ...
        const response: ISignupLoginOutput = {
...
//aqui eu construo o user que veio do findByEmail para conseguir pegar apenas o password
//para comparar\verificar se a senha está correta
        const user = new User(
            userDB.id,
            userDB.name,
            userDB.email,
